...
class MinimumTimeToCollectAllApplesInATree1443Test {
    ...
    void minTime() {
        assertAll(
                () -> test(7, new int[][]{{0, 1}, {0, 2}, {1, 4}, {1, 5}, {2, 3}, {2, 6}}, new ArrayList<>(Arrays.asList(false, false, true, false, true, true, false)), 8),
                () -> test(7, new int[][]{{0, 1}, {0, 2}, {1, 4}, {1, 5}, {2, 3}, {2, 6}}, new ArrayList<>(Arrays.asList(false, false, true, false, false, true, false)), 6),
                () -> test(7, new int[][]{{0, 1}, {0, 2}, {1, 4}, {1, 5}, {2, 3}, {2, 6}}, new ArrayList<>(Arrays.asList(false, false, false, false, false, false, false)), 0)
        );
    }
